...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUI(){
        bil1 = (EditText) findViewById(R.id.edit1);
        bil2 = (EditText) findViewById(R.id.edit2);
        jumlah = (EditText) findViewById(R.id.edit3);
        btnHasil1 = (Button) findViewById(R.id.btn1);
    }
